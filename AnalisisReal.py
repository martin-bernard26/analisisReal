...
if 'kumpulan' not in st.session_state:
    st.session_state['kumpulan'] = {'pendahuluan':True,'catatan':False,'buku':False,'hasil':False,'pertemuan1':False,
                        'pertemuan2':False,'pertemuan3':False, 'pertemuan4':False,'pertemuan5':False,
                                    ...
                                    'pertemuan10':False,'pertemuan11':False,'pertemuan12':False}
...
def materi5():
    menu2 = st.tabs(["Test Awal","Materi","Latihan","Tugas"])
    with menu2[0]:
        tulisanHTML = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/diagnosis6.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML,height=1000)
    with menu2[1]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/pertemuan6.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
    with menu2[2]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/latihan6.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
    with menu2[3]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/tugas6.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
        
def materi6():
    menu2 = st.tabs(["Materi","Latihan Pembuktian","Tugas"])
    with menu2[0]:
        tulisanHTML = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/bilanganReal.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML,height=1000)
    with menu2[1]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/latihanReal.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
    with menu2[2]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/tugasReal.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)

def bahanajar():
    tulisanHTML = """
        <iframe src="https://drive.google.com/file/d/1p3FaM5BWgKk9qqj9KMpCtThO3FIXS0N4/preview" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
    st.components.v1.html(tulisanHTML,height=1000)

def ujianTengah():
    tulisanHTML = """
        <iframe src="https://drive.google.com/file/d/1RxSr-b3CulGpYfzIhodlcjk9GbbNGBes/preview" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
    st.components.v1.html(tulisanHTML,height=1000)
    st.write("Masukan hasilnya di kolom bawah")
    tulisanHTML = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/UTS.html" width="100%" height="500" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
...
def materi7():
    ...
    with menu[0]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/pertemuan7.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
    with menu[1]:
        st.markdown("---")
        st.latex("Pembuktian\\;\\Sigma_{i=1}^{n}i=\\frac{n(n+1)}{2}")
        st.markdown("---")
        st.video("https://youtu.be/CVAr9FVCxpc")
        st.markdown("---")
        st.latex("Pembuktian\\;bahwa\\;x^{3}-x\\;habis\\;dibagi\\;6")
        st.markdown("---")
        st.video("https://youtu.be/55fKhNtBhLI")
        st.markdown("---")
        st.latex("Pembuktian:\\;n!>2^{n}.\\;untuk\\;n\\geq{3}")
        st.markdown("---")
        st.video("https://youtu.be/DWRX9ulB9Io")
    with menu[2]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/induksi.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
    with menu[3]:
        st.write("Dari test diagnosa selesaikan dengan menggunakan tulis tangan lalu dikirimkan")
        tulisanHTML1 = """
...
def materi9():
    menu = st.tabs(['Materi','Media','Video','Angket'])
    with menu[0]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/limit.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
    with menu[1]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/analisis2.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
    with menu[2]:
        st.video("https://youtu.be/c8W-yz1MMcg")

def materi10():
    menu = st.tabs(['Materi 1', 'Materi2','Media','Video','Angket'])
    with menu[0]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/subBarisan.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
    with menu[1]:
        tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/cauchy.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
        st.components.v1.html(tulisanHTML1,height=1000)
    with menu[2]:
        pass
...
def materi11():
    tulisanHTML1 = """
        <iframe src="https://drive.google.com/file/d/1AVA1PUM0Km8tL8CBv6lCoy201KxU5uKy/preview" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
    st.components.v1.html(tulisanHTML1,height=1000)
    tulisanHTML1 = """
        <iframe src="https://martin-bernard26.github.io/simulasiCauchy/UASARB1.html" width="100%" height="1000" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
           """
    st.components.v1.html(tulisanHTML1,height=1000)
...
if st.session_state['kumpulan']['pertemuan5']:
    materi5()
if st.session_state['kumpulan']['pertemuan6']:
    materi6()
if st.session_state['kumpulan']['buku']:
    bahanajar()
if st.session_state['kumpulan']['pertemuan7']:
    ujianTengah()
if st.session_state['kumpulan']['pertemuan8']:
    materi7()
if st.session_state['kumpulan']['pertemuan9']:
    materi8()
if st.session_state['kumpulan']['pertemuan10']:
    materi9()
if st.session_state['kumpulan']['pertemuan11']:
    materi10()
if st.session_state['kumpulan']['pertemuan12']:
    materi11()
#===========Kontrol++++++
...
if st.sidebar.button("Pertemuan 8"):
    st.session_state['kumpulan'] = {'pendahuluan':False,'catatan':False,'buku':False,'hasil':False,'pertemuan1':False,
                        'pertemuan2':False,'pertemuan3':False, 'pertemuan4':False,'pertemuan5':False,
                                    ...
                                    'pertemuan10':False,'pertemuan11':False,'pertemuan12':False}
    st.rerun()
if st.sidebar.button("Pertemuan 9"):
    st.session_state['kumpulan'] = {'pendahuluan':False,'catatan':False,'buku':False,'hasil':False,'pertemuan1':False,
                        'pertemuan2':False,'pertemuan3':False, 'pertemuan4':False,'pertemuan5':False,
                                    'pertemuan6':False,'pertemuan7':False,'pertemuan8':False,'pertemuan9':False,
                                    'pertemuan10':True,'pertemuan11':False,'pertemuan12':False}
    st.rerun()
if st.sidebar.button("Pertemuan 10"):
    st.session_state['kumpulan'] = {'pendahuluan':False,'catatan':False,'buku':False,'hasil':False,'pertemuan1':False,
                        'pertemuan2':False,'pertemuan3':False, 'pertemuan4':False,'pertemuan5':False,
                                    'pertemuan6':False,'pertemuan7':False,'pertemuan8':False,'pertemuan9':False,
                                    'pertemuan10':False,'pertemuan11':True,'pertemuan12':False}
    st.rerun()
st.sidebar.markdown("---")
if st.sidebar.button("Ujian Akhir Semester"):
    st.session_state['kumpulan'] = {'pendahuluan':False,'catatan':False,'buku':False,'hasil':False,'pertemuan1':False,
                        'pertemuan2':False,'pertemuan3':False, 'pertemuan4':False,'pertemuan5':False,
                                    'pertemuan6':False,'pertemuan7':False,'pertemuan8':False,'pertemuan9':False,
                                    'pertemuan10':False,'pertemuan11':False,'pertemuan12':True}
    st.rerun()
